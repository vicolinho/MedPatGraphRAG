...
from kg_construction.io.neo4j.semanatic_network_importer import parse_srstre1, create_indexes, import_sty_nodes, \
...
if __name__ == "__main__":
    ...
    try:
        ...
        # print("Importing Relation nodes ...")
        # import_rl_nodes(driver, rl_nodes)
